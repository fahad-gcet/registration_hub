...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { branch: @register.branch, event_id: @register.event_id, name: @register.name, semester: @register.semester }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { branch: @register.branch, event_id: @register.event_id, name: @register.name, semester: @register.semester }
    assert_redirected_to register_path(assigns(:register))
  end
